...
namespace ArmUsb {
    ...
    public sealed partial class MainPage : Page {
        ...
        string received = "";
        private Int32 xAccel;
        private Int32 yAccel;
        private Int32 zAccel;
        private Int32 an1;
        private Int32 an2;
        private Int32 an3;
                        ...
                        if (received[2] == '#') {        //Is it still following protocol?
                            if (received.Length > 42) {     //Full length?
                                ...
                                if (recChkSum == calChkSum) {
                                    ...
                                    txtYaccel.Text = received.Substring(10, 4);        //Start at 10, 4 long] Analog 0
                                    txtZaccel.Text = received.Substring(14, 4);        //Start at 14, 4 long] Analog 0
                                    txtAN1.Text = received.Substring(18, 4);        //Start at 18, 4 long] Analog 0
                                    txtAN2.Text = received.Substring(22, 4);        //Start at 22, 4 long] Analog 0
                                    ...
                                    #region Get Parsed Data
                                    xAccel = Convert.ToInt32(received.Substring(6, 4));    
                                    yAccel = Convert.ToInt32(received.Substring(10, 4));   
                                    zAccel = Convert.ToInt32(received.Substring(14, 4));
                                    an1 = Convert.ToInt32(received.Substring(18, 4));   
                                    an2 = Convert.ToInt32(received.Substring(22, 4));  
                                    an3 = Convert.ToInt32(received.Substring(26, 4));
                                    #endregion

                                    #region Display Parsed Data
                                    txtXaccelPar.Text = xAccel.ToString();
                                    txtYaccelPar.Text = yAccel.ToString();
                                    txtZaccelPar.Text = zAccel.ToString();
                                    txtAn1Par.Text = an1.ToString();
                                    txtAn2Par.Text = an2.ToString();
                                    txtAn3Par.Text = an3.ToString();
                                    #endregion
